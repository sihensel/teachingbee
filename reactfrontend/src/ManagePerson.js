...
class ManagePerson extends React.Component {
    constructor(props) {
      ...
      this.state = {
        ...
        fetch('http://localhost:5000/person/', {
            ...
            course: data.course, studytype: data.studytype, extroverted: data.extroverted, frequency: data.frequency, online: data.online }));
    }
    ...
    render() {
        ...
        // das Studiengang aus der Datenbank aus der Liste entfernen
